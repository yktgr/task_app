...
User.create(name:"test1",email:"1@t.com",password:"1",admin: true)
User.create(name:"test2",email:"2@t.com",password:"2",admin: true)
...
Task.create(title:"test",content:"test",status:"start",priority:"high",user_id:3)
